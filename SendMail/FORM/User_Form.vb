Public Class User_Form
    ...
    Dim sl As Integer
    Private Sub User_Form_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cmb1()
        cmb2()
    ...
    End Sub
    Sub showdg()
        dsUser = getSqldb2("select USER_ID,User_Name,SBU,Password,case when Security_Level = 0 Then 'Administrator' Else 'User' End As Security_Level,case when Group_ID = 0 Then 'Administrator' Else 'User' End As Group_ID from Users Where Deleted = '0'")
    ...
    Private Sub DataGridView1_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataGridView1.CellClick
        Try
            ...
            TextBox3.Text = Microsoft.VisualBasic.Left(DataGridView1.Item(3, DataGridView1.CurrentRow.Index).Value, 20)
