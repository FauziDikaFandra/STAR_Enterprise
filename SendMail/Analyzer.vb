...
Public Class analyzer
    ...
    Private Sub analyzer_FormClosing(ByVal sender As Object, ByVal e As FormClosingEventArgs) Handles MyBase.FormClosing
    ...
    Private Sub PerTanggalToolStripMenuItem_Click(ByVal sender As Object, ByVal e As EventArgs) Handles PerTanggalToolStripMenuItem.Click
        Call functionparam()
    End Sub
    ...
    Private Sub rdallsales_CheckedChanged(ByVal sender As Object, ByVal e As EventArgs) Handles rdallsales.CheckedChanged
        If rdallsales.Checked Then
            txtvalue1.Enabled = False
        End If
    End Sub

    Private Sub analyzer_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
        Call defaults()
    End Sub

    Private Sub tm1_Tick(ByVal sender As Object, ByVal e As EventArgs) Handles tm1.Tick
    ...
    Private Sub rdsalescustom_CheckedChanged(ByVal sender As Object, ByVal e As EventArgs) Handles rdsalescustom.CheckedChanged
        If rdsalescustom.Checked Then
