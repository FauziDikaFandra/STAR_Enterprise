...
Public Class PromoReportAll
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "STAR_Enterprise.PromoReportAll.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPromoReportAll
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PromoReportAll = New PromoReportAll()
        rpt.Site = Me.Site
        Return rpt
    End Function
