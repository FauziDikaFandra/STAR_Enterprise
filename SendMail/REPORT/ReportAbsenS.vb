...
Public Class ReportAbsenS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "STAR_Enterprise.ReportAbsenS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportAbsenS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportAbsenS = New ReportAbsenS()
        rpt.Site = Me.Site
        Return rpt
    End Function
