...
Public Class ReportAbsenD
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "STAR_Enterprise.ReportAbsenD.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportAbsenD
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportAbsenD = New ReportAbsenD()
        rpt.Site = Me.Site
        Return rpt
    End Function
