...
Public Class RptTandaTerima2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "STAR_Enterprise.RptTandaTerima2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptTandaTerima2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptTandaTerima2 = New RptTandaTerima2()
        rpt.Site = Me.Site
        Return rpt
    End Function
