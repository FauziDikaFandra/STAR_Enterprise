...
Public Class vocreportcheck
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "STAR_Enterprise.vocreportcheck.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedvocreportcheck
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As vocreportcheck = New vocreportcheck()
        rpt.Site = Me.Site
        Return rpt
    End Function
